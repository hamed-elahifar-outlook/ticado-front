<template>
  <UiCard class="bg-white rounded-lg shadow p-6">
    ...
    <UiTable>
      <UiTableHeader>
        <UiTableRow>
          <UiTableCell class="text-right">{{ $t('gifts_section.questionnaire_title') }}</UiTableCell>
          <UiTableCell class="text-right">{{ $t('gifts_section.status') }}</UiTableCell>
          <UiTableCell class="text-right">{{ $t('gifts_section.time_spent') }}</UiTableCell>
          <UiTableCell class="text-right">{{ $t('gifts_section.score') }}</UiTableCell>
          <UiTableCell class="text-right">{{ $t('gifts_section.date') }}</UiTableCell>
        </UiTableRow>
      </UiTableHeader>
      <UiTableBody>
        <!-- Empty State -->
        ...
        <UiTableRow v-for="questionnaire in filteredQuestionnaires" :key="questionnaire.id">
          <UiTableCell class="text-right">{{ questionnaire.title }}</UiTableCell>
          ...
          <UiTableCell class="text-right">{{ questionnaire.timeSpent }}</UiTableCell>
          <UiTableCell class="text-right font-semibold">{{ questionnaire.score }}</UiTableCell>
          <UiTableCell class="text-right">{{ questionnaire.date }}</UiTableCell>
        </UiTableRow>
      </UiTableBody>
    </UiTable>
  </UiCard>
